...
#if (CFG_NSIH_EN == 0)
// PLL0 for memory
//	clkpwr->PLLSETREG[0] = (U32)((1UL<<28)|(PLL01_PMS_1600MHZ_S<<PLL_S) | (PLL01_PMS_1600MHZ_M<<PLL_M) | (PLL01_PMS_1600MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[0] = (U32)((1UL<<28)|(PLL01_PMS_1100MHZ_S<<PLL_S) | (PLL01_PMS_1100MHZ_M<<PLL_M) | (PLL01_PMS_1100MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[0] = (U32)((1UL<<28)|(PLL01_PMS_1000MHZ_S<<PLL_S) | (PLL01_PMS_1000MHZ_M<<PLL_M) | (PLL01_PMS_1000MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[0] = (U32)((1UL<<28)|(PLL01_PMS_933MHZ_S<<PLL_S) | (PLL01_PMS_933MHZ_M<<PLL_M) | (PLL01_PMS_933MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[0] = (U32)((1UL<<28)|(PLL01_PMS_800MHZ_S<<PLL_S) | (PLL01_PMS_800MHZ_M<<PLL_M) | (PLL01_PMS_800MHZ_P<<PLL_P));
	clkpwr->PLLSETREG[0] = (U32)((1UL<<28)|(PLL01_PMS_600MHZ_S<<PLL_S) | (PLL01_PMS_600MHZ_M<<PLL_M) | (PLL01_PMS_600MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[0] = (U32)((1UL<<28)|(PLL01_PMS_666MHZ_S<<PLL_S) | (PLL01_PMS_666MHZ_M<<PLL_M) | (PLL01_PMS_666MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[0] = (U32)((1UL<<28)|(PLL01_PMS_533MHZ_S<<PLL_S) | (PLL01_PMS_533MHZ_M<<PLL_M) | (PLL01_PMS_533MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[0] = (U32)((1UL<<28)|(PLL01_PMS_400MHZ_S<<PLL_S) | (PLL01_PMS_400MHZ_M<<PLL_M) | (PLL01_PMS_400MHZ_P<<PLL_P));


// PLL1 for CPU
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_1800MHZ_S<<PLL_S) | (PLL01_PMS_1800MHZ_M<<PLL_M) | (PLL01_PMS_1800MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_1700MHZ_S<<PLL_S) | (PLL01_PMS_1700MHZ_M<<PLL_M) | (PLL01_PMS_1700MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_1600MHZ_S<<PLL_S) | (PLL01_PMS_1600MHZ_M<<PLL_M) | (PLL01_PMS_1600MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_1500MHZ_S<<PLL_S) | (PLL01_PMS_1500MHZ_M<<PLL_M) | (PLL01_PMS_1500MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_1400MHZ_S<<PLL_S) | (PLL01_PMS_1400MHZ_M<<PLL_M) | (PLL01_PMS_1400MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_1300MHZ_S<<PLL_S) | (PLL01_PMS_1300MHZ_M<<PLL_M) | (PLL01_PMS_1300MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_1200MHZ_S<<PLL_S) | (PLL01_PMS_1200MHZ_M<<PLL_M) | (PLL01_PMS_1200MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_1100MHZ_S<<PLL_S) | (PLL01_PMS_1100MHZ_M<<PLL_M) | (PLL01_PMS_1100MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_1000MHZ_S<<PLL_S) | (PLL01_PMS_1000MHZ_M<<PLL_M) | (PLL01_PMS_1000MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_999MHZ_S<<PLL_S) | (PLL01_PMS_999MHZ_M<<PLL_M) | (PLL01_PMS_999MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_933MHZ_S<<PLL_S) | (PLL01_PMS_933MHZ_M<<PLL_M) | (PLL01_PMS_933MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_810MHZ_S<<PLL_S) | (PLL01_PMS_810MHZ_M<<PLL_M) | (PLL01_PMS_810MHZ_P<<PLL_P));
	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_800MHZ_S<<PLL_S) | (PLL01_PMS_800MHZ_M<<PLL_M) | (PLL01_PMS_800MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_720MHZ_S<<PLL_S) | (PLL01_PMS_720MHZ_M<<PLL_M) | (PLL01_PMS_720MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_666MHZ_S<<PLL_S) | (PLL01_PMS_666MHZ_M<<PLL_M) | (PLL01_PMS_666MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_533MHZ_S<<PLL_S) | (PLL01_PMS_533MHZ_M<<PLL_M) | (PLL01_PMS_533MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[1] = (U32)((1UL<<28)|(PLL01_PMS_400MHZ_S<<PLL_S) | (PLL01_PMS_400MHZ_M<<PLL_M) | (PLL01_PMS_400MHZ_P<<PLL_P));


// PLL2 for BCLK, 3DCLK
	clkpwr->PLLSETREG[2] = (U32)((1UL<<28)|(PLL23_PMS_800MHZ_S<<PLL_S) | (PLL23_PMS_800MHZ_M<<PLL_M) | (PLL23_PMS_800MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[2] = (U32)((1UL<<28)|(PLL23_PMS_666MHZ_S<<PLL_S) | (PLL23_PMS_666MHZ_M<<PLL_M) | (PLL23_PMS_666MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[2] = (U32)((1UL<<28)|(PLL23_PMS_614MHZ_S<<PLL_S) | (PLL23_PMS_614MHZ_M<<PLL_M) | (PLL23_PMS_614MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[2] = (U32)((1UL<<28)|(PLL23_PMS_600MHZ_S<<PLL_S) | (PLL23_PMS_600MHZ_M<<PLL_M) | (PLL23_PMS_600MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[2] = (U32)((1UL<<28)|(PLL23_PMS_550MHZ_S<<PLL_S) | (PLL23_PMS_550MHZ_M<<PLL_M) | (PLL23_PMS_550MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[2] = (U32)((1UL<<28)|(PLL23_PMS_400MHZ_S<<PLL_S) | (PLL23_PMS_400MHZ_M<<PLL_M) | (PLL23_PMS_400MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[2] = (U32)((1UL<<28)|(PLL23_PMS_333MHZ_S<<PLL_S) | (PLL23_PMS_333MHZ_M<<PLL_M) | (PLL23_PMS_333MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[2] = (U32)((1UL<<28)|(PLL23_PMS_295MHZ_S<<PLL_S) | (PLL23_PMS_295MHZ_M<<PLL_M) | (PLL23_PMS_295MHZ_P<<PLL_P));


// PLL3 for others (Audio)
//	clkpwr->PLLSETREG[3] = (U32)((1UL<<28)|(PLL23_PMS_900MHZ_S<<PLL_S) | (PLL23_PMS_900MHZ_M<<PLL_M) | (PLL23_PMS_900MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[3] = (U32)((1UL<<28)|(PLL23_PMS_800MHZ_S<<PLL_S) | (PLL23_PMS_800MHZ_M<<PLL_M) | (PLL23_PMS_800MHZ_P<<PLL_P));
	clkpwr->PLLSETREG[3] = (U32)((1UL<<28)|(PLL23_PMS_614MHZ_S<<PLL_S) | (PLL23_PMS_614MHZ_M<<PLL_M) | (PLL23_PMS_614MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[3] = (U32)((1UL<<28)|(PLL23_PMS_600MHZ_S<<PLL_S) | (PLL23_PMS_600MHZ_M<<PLL_M) | (PLL23_PMS_600MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[3] = (U32)((1UL<<28)|(PLL23_PMS_550MHZ_S<<PLL_S) | (PLL23_PMS_550MHZ_M<<PLL_M) | (PLL23_PMS_550MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[3] = (U32)((1UL<<28)|(PLL23_PMS_500MHZ_S<<PLL_S) | (PLL23_PMS_500MHZ_M<<PLL_M) | (PLL23_PMS_500MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[3] = (U32)((1UL<<28)|(PLL23_PMS_400MHZ_S<<PLL_S) | (PLL23_PMS_400MHZ_M<<PLL_M) | (PLL23_PMS_400MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[2] = (U32)((1UL<<28)|(PLL23_PMS_333MHZ_S<<PLL_S) | (PLL23_PMS_333MHZ_M<<PLL_M) | (PLL23_PMS_333MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[3] = (U32)((1UL<<28)|(PLL23_PMS_295MHZ_S<<PLL_S) | (PLL23_PMS_295MHZ_M<<PLL_M) | (PLL23_PMS_295MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[3] = (U32)((1UL<<28)|(PLL23_PMS_250MHZ_S<<PLL_S) | (PLL23_PMS_250MHZ_M<<PLL_M) | (PLL23_PMS_250MHZ_P<<PLL_P));
//	clkpwr->PLLSETREG[3] = (U32)((1UL<<28)|(PLL23_PMS_125MHZ_S<<PLL_S) | (PLL23_PMS_125MHZ_M<<PLL_M) | (PLL23_PMS_125MHZ_P<<PLL_P));
...
#if (CFG_NSIH_EN == 0)
	// CPUDVOREG
	clkpwr->DVOREG[0] = (U32)((1<<CLKSRC)|		// PLL Select
							((1-1)<<DVO0)|		// FCLK	==> CPU Group 0
							((4-1)<<DVO1));		// HCLK ==> CPU bus (max 250MHz)

	// CPUDVOREG
	clkpwr->DVOREG[7] = (U32)((1<<CLKSRC)|		// PLL Select
							((1-1)<<DVO0)|		// FCLK ==> CPU Group1
							((4-1)<<DVO1));		// HCLK ==> CPU bus (max 250MHz)

	// BUSDVOREG
	clkpwr->DVOREG[1] = (U32)((2<<CLKSRC)|		// PLL Select
							((2-1)<<DVO0)|		// BCLK ==> System bus (max 333MHz)
							((2-1)<<DVO1));		// PCLK ==> Peripheral bus (max 166MHz)

	// MEMDVOREG
	clkpwr->DVOREG[2] = (U32)((2<<CLKSRC)|		// PLL Select
...
void DisplayClkSet(void)
{
	...
	printf(" Divider7 PLL: %d CPU Group1:%d   CPU BUS:%d\r\n",
	...
	printf(" Divider8 PLL: %d FAST BUS BCLK:%d   PCLK:%d\r\n",
	...
	printf(" Divider1 PLL: %d BCLK:%d   PCLK:%d\r\n",
	...
	printf(" Divider5 PLL: %d DISPLAY BCLK:%d   PCLK:%d\r\n",
	...
	printf(" Divider2 PLL: %d MDCLK:%d   MCLK:%d   \r\n\t\t MBCLK:%d   MPCLK:%d\r\n",
	...
	printf(" Divider6 PLL: %d HDMI PCLK:%d\r\n",
